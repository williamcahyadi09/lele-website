...
#### Scenario: Tag badge is center-aligned on mobile
- **WHEN** the viewport width is below 768px
- **THEN** the tag badge SHALL be horizontally centered
...
#### Scenario: Text is center-aligned on mobile
- **WHEN** the viewport width is below 768px
- **THEN** the headline and subtitle SHALL be center-aligned
- **AND** on viewports 768px or above the text SHALL be left-aligned
...
#### Scenario: Button group is centered on mobile
- **WHEN** the viewport width is below 768px
- **THEN** the CTA button group SHALL be horizontally centered
- **AND** on viewports 768px or above the button group SHALL be left-aligned
